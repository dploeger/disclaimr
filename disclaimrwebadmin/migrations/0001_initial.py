    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('search_query', models.TextField(default=b'mail=${email}', help_text='A search query to run against the directory server to fetch the ldap object when resolving. ${email} will be replaced when resolving.', verbose_name='search query')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_use_template', models.BooleanField(default=True, help_text='Use template tags in the text part. Available tags are: %(sender)s, %(recipient)s and all attributes, that are provided by resolving the sender in a directory server', verbose_name='use template tags')),
                ...
                ('html_use_template', models.BooleanField(default=True, help_text='Use template tags in the html part. Available tags are: ${sender}, ${recipient} and all attributes, that are provided by resolving the sender in a directory server enclosed in ${}', verbose_name='use template tags')),
        ...
        migrations.AddField(
            model_name='action',
            name='disclaimer',
            field=models.ForeignKey(to='disclaimrwebadmin.Disclaimer'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='action',
