...
# Generate a SECRET_KEY if it hasn't been already set. Taken from https://gist.github.com/ndarville/3452907
...
try:
    ...
    try:
        ...
        try:
            import random
            SECRET_KEY = ''.join([random.SystemRandom().choice('abcdefghijklmnopqrstuvwxyz0123456789!@#$%^&*(-_=+)') for i in
                                  range(50)])
