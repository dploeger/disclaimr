...
class Requirement(models.Model):
    ...
    action = models.SmallIntegerField(_("action"), help_text=_("What to do, if this requirement is met?"), choices=(
        (disclaimrweb.REQ_ACTION_ACCEPT, _("Accept rule")),
        (disclaimrweb.REQ_ACTION_DENY, _("Deny rule"))
    ), default=disclaimrweb.REQ_ACTION_ACCEPT)
...
class Action(models.Model):
    ...
    action = models.SmallIntegerField(_("action"), help_text=_("What action should be done?"), choices=(
        (disclaimrweb.ACTION_ACTION_REPLACETAG, _("Replace a tag in the body with a disclaimer string")),
        (disclaimrweb.ACTION_ACTION_ADD, _("Add a disclaimer string to the body")),
    ), default=disclaimrweb.ACTION_ACTION_ADD)
...
class DirectoryServer(models.Model):
    ...
    auth = models.SmallIntegerField(_("auth_method"), help_text=_("Authentication method to connect to the server"), choices=(
        (disclaimrweb.DIR_AUTH_NONE, _("None")),
        (disclaimrweb.DIR_AUTH_SIMPLE, _("Simple"))
    ), default=disclaimrweb.DIR_AUTH_NONE)
